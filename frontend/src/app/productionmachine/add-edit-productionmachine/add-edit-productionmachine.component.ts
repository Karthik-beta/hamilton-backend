...
@Component({
  selector: 'app-add-edit-productionmachine',
  templateUrl: './add-edit-productionmachine.component.html',
  styleUrls: ['./add-edit-productionmachine.component.css']
})
export class AddEditProductionmachineComponent {
