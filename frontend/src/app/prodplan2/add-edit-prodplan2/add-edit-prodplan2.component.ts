...
@Component({
  selector: 'app-add-edit-prodplan2',
  templateUrl: './add-edit-prodplan2.component.html',
  styleUrls: ['./add-edit-prodplan2.component.css']
})
export class AddEditProdplan2Component {
    ...
    this.service.addProductionPlan(plan).subscribe({
      next: (response) => {
        ...
        this.messageService.add({
          severity: 'success',
          summary: 'Success',
          detail: 'Successfully Added New Production Plan'
        });
